...
var modal = new graph_modal__WEBPACK_IMPORTED_MODULE_0__["default"](); // Реализация табов
...
}, _defineProperty(_windowEl$documentEl$, "passwordBtns", document.querySelectorAll('.security-password-btn')), _defineProperty(_windowEl$documentEl$, "qrBtn", document.querySelector('.step-qr-show')), _defineProperty(_windowEl$documentEl$, "headerBtn", document.querySelector('.action-dropdown')), _windowEl$documentEl$);
...
if (chartBox) {
  ...
  var chart = new (apexcharts__WEBPACK_IMPORTED_MODULE_1___default())(chartBox, options);
  chart.render();
}
...
if (graphBox) {
  ...
  var chart = new (apexcharts__WEBPACK_IMPORTED_MODULE_1___default())(graphBox, options);
...
var swhitcherTrade = document.querySelector('.swhitcher-label');

if (_toConsumableArray(trade).length > 0) {
  swhitcherTrade.addEventListener('click', function () {
